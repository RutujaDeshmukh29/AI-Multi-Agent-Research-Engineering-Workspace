                ...
                {[
                  {
                    ...
                    action: () => socialLogin({ email: "github-user@nexus.ai", name: "GitHub Dev Node", provider: "github" }),
                    icon: (
                  ...
                  },
                  {
                    ...
                    action: () => socialLogin({ email: "google-user@nexus.ai", name: "Google Dev Node", provider: "google" }),
                    icon: (
